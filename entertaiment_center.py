...
matrix = media.Movie("Matrix",
                     "Não importa o quão difícil seja uma situação, o quão pequenas sejam suas chances de conseguir sucesso ou o preço a ser pago pela verdade, ainda assim valerá a pena lutar.",
...
senhor_dos_aneis = media.Movie("O Senhor dos Aneis",
                               ...
                               "http://br.web.img3.acsta.net/c_215_290/medias/nmedia/18/92/91/32/20224832.jpg",
...
spider_man = media.Movie("Homem-Aranha",
                         "A historia de um homen picado por uma aranha que vira super heroe",
                         "https://pm1.narvii.com/6122/25c286a99381ef79bb8df1dfaee31685390b502b_hq.jpg",
...
divergente = media.Movie("Divergente",
                         "A história introduz a vida de Beatrice Prior, uma corajosa jovem de 16 anos que ameaça destruir o sistema implantado na cidade, pois não corresponde aos padrões estabelecidos pela mesma.",
                         "https://upload.wikimedia.org/wikipedia/pt/thumb/8/8e/Divergent.png/240px-Divergent.png",
...
limitless = media.Movie("Sem Limites",
                        "Com uma droga voce pode utilizar todo o poder do cerebro  e virar tecnicamente sem limites.",
                        "https://upload.wikimedia.org/wikipedia/pt/1/17/Limitless_Poster.jpg",
...
maze_runner = media.Movie("Maze Runner - Correr o Morrer",
                          ...
                          "https://upload.wikimedia.org/wikipedia/pt/c/c7/Maze_runner.jpg",
...
os_300 = media.Movie("300",
                     ...
                     "https://upload.wikimedia.org/wikipedia/pt/1/19/300_poster.jpg",
                     "https://www.youtube.com/watch?v=mi4xUUJSuro")

#Criada lista de filmes (movies) e adicionadas todas as instancias de filmes anteriores
movies = [matrix,senhor_dos_aneis,spider_man,divergente,limitless,hunger_games,maze_runner,transformers,os_300]

#utilizado o metodo open_movies_page do arquivo fresh_tomatoes para abrir uma pagina web no browser e exibir todos os filmes que estam na lista movies, este metodo recebe como parametro a lista movies
